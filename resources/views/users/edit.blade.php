                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="active" name="active" class="form-control @error('active') is-invalid @enderror" required autocomplete="active">
                                    <option value="{{ $user->active }}">@if ($user->active==1) Activo @else Inactivo
                                    @endif</option>
