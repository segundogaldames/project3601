                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('recursos.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="anio" type="number" class="form-control @error('anio') is-invalid @enderror" name="anio" value="{{ old('anio') }}" required autocomplete="nombre" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="descripcion" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" required autocomplete="direccion" autofocus style="resize: none" rows="6">{{ old('descripcion') }}</textarea>
